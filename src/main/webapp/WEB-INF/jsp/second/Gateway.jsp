...
<head>
    ...
    <link href="files/门户管理/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/门户管理/data.js"></script>
...
<body>
    ...
    <div id="u0" class="ax_图片">
        <img id="u0_img" class="img " src="images/门户管理/u0.png"/>
        <!-- Unnamed () -->
    ...
    <div id="u2" class="ax_图片">
        <img id="u2_img" class="img " src="images/代理商客户管理/u46.png"/>
        <!-- Unnamed () -->
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u5" class="ax_文本框_单行_">
        <input id="u5_input" type="text" value=""/>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u6" class="ax_图片">
        <img id="u6_img" class="img " src="images/门户管理/u6.png"/>
        <!-- Unnamed () -->
    ...
    <div id="u12" class="ax_图片">
        <img id="u12_img" class="img " src="images/门户管理/u12.png"/>
        <!-- Unnamed () -->
